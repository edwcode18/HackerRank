...
class HuffmanNode2 extends Node2 {

    public HuffmanNode2(Node2 l, Node2 r) {
...
public class TreeHuffmanDecoding {
    ...
    public static Node2 buildTree(int[] charFreqs) {
        ...
        while (trees.size() > 1) {
            ...
            // put into new Node2 and re-insert into queue
    ...
    public static void printCodes(Node2 tree, StringBuffer prefix) {
        ...
        if (tree instanceof HuffmanLeaf) {
            ...
            HuffmanNode2 Node2 = (HuffmanNode2)tree;

            // traverse left
            prefix.append('0');
            printCodes(Node2.left, prefix);
            prefix.deleteCharAt(prefix.length()-1);

            // traverse right
            prefix.append('1');
            printCodes(Node2.right, prefix);
            prefix.deleteCharAt(prefix.length()-1);
        }
    }
